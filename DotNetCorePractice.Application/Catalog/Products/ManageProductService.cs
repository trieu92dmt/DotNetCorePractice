...
namespace DotNetCorePractice.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public ManageProductService(DotNetCorePracticeDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        public async Task<int> Delete(int productId)
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null)
                throw new DotNetCorePracticeException($"Cannot find a product: {productId}");
            
            var images = _context.ProductImages.Where(x => x.IsDefault == true && x.ProductId == productId);
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null)
                throw new DotNetCorePracticeException($"Cannot find a product: {request.Id}");
        ...
        public async Task<int> RemoveImage(int productId, int imageId)
        {
            ...
            if (productImage == null)
                throw new DotNetCorePracticeException("Cannot find");
